{ config, perSystem, ... }:
{
  ...
  #       repo = "zed";
  #       rev = "9bd3dbcf284d80629bde23367d89f0825ee5e954";
  #       hash = "sha256-g8TmK1wi1f5DyFHPjFacoFz6vvOQydV5XH53Ke2r4mI=";
  #     };
  #   }
  # );

  # # package = perSystem.zed.default;
  # package = pkgs.zed-editor.overrideAttrs (
  #   finalAttrs: previousAttrs: {
  #     src = pkgs.fetchFromGitHub {
  #       owner = "zed-industries";
  #       repo = "zed";
  #       rev = "cd85b430e42fd9b198fc7ac943b546ec816ead31";
  #       hash = "sha256-PcqSzMwZ9wAtpHT3YeZMr3jCnUzrG4tm+GACDMvljN4=";
  #     };
  #   }
  # );

  # TODO symlink OOS config files?
